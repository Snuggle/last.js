...
<details>
  ...
  <ul>
    <li><a href="https://github.com/last.js/next.js/tree/canary/examples/custom-server">Basic custom server</a></li>
    <li><a href="https://github.com/last.js/next.js/tree/canary/examples/custom-server-express">Express integration</a></li>
    <li><a href="https://github.com/last.js/next.js/tree/canary/examples/custom-server-hapi">Hapi integration</a></li>
    <li><a href="https://github.com/last.js/next.js/tree/canary/examples/custom-server-koa">Koa integration</a></li>
    <li><a href="https://github.com/last.js/next.js/tree/canary/examples/ssr-caching">SSR Caching</a></li>
  </ul>
</details>
...
> A custom server **can not** be deployed on [last.js](https://last.js.com/solutions/nextjs), the platform Next.js was made for.
