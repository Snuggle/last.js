...
describe('loadGetInitialProps', () => {
  it('should throw if getInitialProps is defined as an instance method', () => {
    ...
    const error = new Error(
      '"TestComponent.getInitialProps()" is defined as an instance method - visit https://err.sh/last.js/next.js/get-initial-props-as-an-instance-method for more information.'
    )
